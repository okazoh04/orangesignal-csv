 ...
 */
class ColumnNameLessThanOrEqualExpressionTest {

	@Test
	void testColumnNameLessThanOrEqualExpressionIllegalArgumentException1() {
	...
	@Test
	void testColumnNameLessThanOrEqualExpressionIllegalArgumentException2() {
		assertThrows(IllegalArgumentException.class, () -> {
